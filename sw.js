const CACHE_NAME = "istone-reader-pwa-v44";
...
const LIVE_ASSET_URLS = new Set(
  ["./", "./index.html", "./app.js", "./library.js", "./neural-voice.js", "./text-pipeline.mjs", "./ocr-render-worker.js", "./styles.css", "./manifest.webmanifest", "./sw.js"].map(
